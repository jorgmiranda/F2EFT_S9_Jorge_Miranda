...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">actividad-examen documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/EditarPerfilComponent.html" data-type="entity-link" >EditarPerfilComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/EditarProductosComponent.html" data-type="entity-link" >EditarProductosComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/FooterComponent.html" data-type="entity-link" >FooterComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/InicioAdminComponent.html" data-type="entity-link" >InicioAdminComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/InicioComponent.html" data-type="entity-link" >InicioComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/ListaUsuariosComponent.html" data-type="entity-link" >ListaUsuariosComponent</a>
                            </li>
                            <li class="link">
